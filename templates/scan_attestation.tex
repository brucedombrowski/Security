...
\midrule
\texttt{host-inventory-\ScanFileTimestamp.txt} & \texttt{\HostInventoryChecksum} \\
\texttt{pii-scan-\ScanFileTimestamp.txt} & See checksums.md \\
\texttt{malware-scan-\ScanFileTimestamp.txt} & See checksums.md \\
\texttt{secrets-scan-\ScanFileTimestamp.txt} & See checksums.md \\
\texttt{mac-address-scan-\ScanFileTimestamp.txt} & See checksums.md \\
\texttt{host-security-scan-\ScanFileTimestamp.txt} & See checksums.md \\
\texttt{security-scan-report-\ScanFileTimestamp.txt} & See checksums.md \\
\bottomrule
\end{tabular}
}
